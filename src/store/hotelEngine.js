    ...
    persist(
        (set, get) => ({
            ...
            initFromCh2: (ch2State) => set({
                ...
                allPreviousSkills: [
                    ...(ch2State.allPreviousSkills || ch2State.ch1Skills || []),
                    ...(ch2State.ch2Skills || []),
                ],
            ...
            confirmWeek: (actions) => {
                const state = get();
                set({ phase: 'ch3-simulating', _weeklyFocus: actions?._focus || {} });
                ...
                setTimeout(() => {
                    ...
                    set({
                        ...
                        _goalRevparWeeks: (result.revpar || 0) >= 8000 ? (s._goalRevparWeeks || 0) + 1 : 0,
                        _goalAchieved: s._goalAchieved || ((result.revpar || 0) >= 8000 && ((s._goalRevparWeeks || 0) + 1) >= 4),
                        phase: 'ch3-results',
                    });
                }, 100);
            },
